    ...
    async actualizarDatosOwner() {
      ...
      try {
        ...
        if (responseUpdate.status === 200) {
          ...
          localStorage.setItem("usuarioCorreo", this.gmail); // Actualizar el correo en el localStorage

          Swal.fire({
            icon: 'success',
            title: '¡Éxito!',
            text: 'Los datos del propietario han sido actualizados correctamente.',
          });
...
<template>
  ...
  <main class="center-container" style="margin-top: 100px;">
    ...
    <h2>Nombres</h2><br>
    <pv-input placeholder="Nombres" v-model="name" style="font-family: 'Poppins',sans-serif"
              role="textbox"></pv-input>
    <br>
    <h2>Apellidos</h2><br>
    <pv-input placeholder="Apellidos" v-model="last_name" style="font-family: 'Poppins',sans-serif"
              role="textbox"></pv-input>
    <br>
    <h2>Celular</h2><br>
    <pv-input placeholder="Celular" v-model="cellphone" style="font-family: 'Poppins',sans-serif"
              role="textbox"></pv-input>
    <br>
    ...
    <br>
    <h2>Contraseña</h2><br>
    <pv-input placeholder="Nueva contraseña" v-model="password" type="password"
              style="font-family: 'Poppins',sans-serif" role="textbox"></pv-input>
    <br>
    <h2>Correo electrónico</h2><br>
    <pv-input placeholder="Nuevo correo electrónico" v-model="gmail" style="font-family: 'Poppins',sans-serif"
              role="textbox"></pv-input>
    <br>
