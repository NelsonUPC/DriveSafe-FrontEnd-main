        ...
        <template #end>
          <div class="flex-column">
            ...
            <router-link to="/profile-tenant">
              <img src="https://i.postimg.cc/Fs9Z3g3V/usuario-1.png" alt="Usuario"
      ...
      <div v-else>
        <div v-for="alquiler in alquileres" :key="alquiler.id">
          <Card class="custom-card">
            <template #title>
              <h2>Detalles del alquiler {{ alquiler.id }}</h2>
            </template>
            <template #content>
              ...
              <p>Propietario: {{ alquiler.propietario ? alquiler.propietario.nombres : 'No disponible' }}</p>
              ...
              <button v-if="alquiler.estado === 'Aceptado'" @click="irAPagar(alquiler)" class="custom-button">Ir a
                Pagar
              </button>
