  ...
  methods: {
    async cargarInformacionArrendatario() {
      try {
        ...
        this.user.last_name = localStorage.getItem("usuarioApellidos");

        this.user.cellphone = localStorage.getItem("usuarioCelular");

        this.user.gmail = localStorage.getItem("usuarioCorreo");
